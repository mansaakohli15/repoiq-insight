...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RepoIQ — AI GitHub Repository Analysis" },
      {
        name: "description",
        content:
          "RepoIQ analyzes any GitHub repository with AI: health scores, summaries, and improvement plans.",
      },
      { name: "author", content: "RepoIQ" },
